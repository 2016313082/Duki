 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIDuk12021oUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309620215465542496749683645');
 ...
 */
	//Configure::write('Config.timezone', 'America/Mexico City');
