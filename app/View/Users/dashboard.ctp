                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div id="total_vendido" style="font-size:25px;"></div>
                                            <div>Total <br>vendido</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="#">
                            ...
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div id="total_productos" style="font-size:25px;"></div>
                                            <div>Productos <BR>activos</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="#">
                            ...
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div id="total_pedidos" style="font-size:25px;"></div>
                                            <div>Pedidos terminados</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="#">
                            ...
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div id='contador_usuarios' style="font-size:25px;"></div>
                                            <div>Usuarios registrados
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <a href="<?= $this->webroot; ?>usuarios">
                                    <div class="panel-footer">
                                        <span class="pull-left">Ver detalles</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
